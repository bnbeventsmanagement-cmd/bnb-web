...
export const SEO_CONSTANTS = {
  ...
  SITE_DESCRIPTION: 'B&B מספקת שירותי אישורי הגעה לחתונה, דיילות להושבה וניהול אורחים מקצועי. שירותי RSVP, סידור הושבה וצוות קבלת פנים לחתונות ואירועים.',
  ...
  // Meta Tags
  DEFAULT_TITLE: 'אישורי הגעה לחתונה | B&B - דיילות להושבה וניהול אורחים',
...
export const PAGE_SEO = {
  home: {
    title: 'אישורי הגעה לחתונה | B&B - שירותי אירועים מקצועיים',
    description: 'אישורי הגעה לחתונה, דיילות להושבה וניהול אורחים מקצועי. B&B מספקת שירותי RSVP, סידור הושבה וצוות קבלת פנים לחתונות ואירועים.',
    keywords: ['אישורי הגעה לחתונה', 'אישורים לחתונה', 'דיילות להושבה', 'סידור הושבה', 'ניהול אורחים', 'צוות קבלת פנים', 'RSVP לחתונה']
  },
  about: {
