...
const About = () => {
  ...
  return (
    <>
      <Seo 
        title="אודותינו | B&B אישורי הגעה"
        description="למדו על B&B אישורי הגעה - החברה המובילה בישראל לשירותי אישורי הגעה, ניהול הושבה ודיילות לאירועים. ניסיון של שנים בשוק הישראלי."
        keywords={[
          "אודות B&B",
          "חברת אישורי הגעה",
          "ניסיון באירועים",
          "שירותי אירועים בישראל",
          "מקצועיות באירועים"
        ]}
        canonical="/about"
